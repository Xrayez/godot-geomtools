...
public:
	...
	Array merge_polygons_array(Array p_polygons) const;
	Array clip_polygons_array(Array p_polygons_a, Array p_polygons_b) const;
	...
	Array clip_polylines_with_polygons_array(const Array &p_polylines, const Array &p_polygons) const;
	Array intersect_polylines_with_polygons_array(const Array &p_polylines, const Array &p_polygons) const;
